...
const faqs = [
  ...
  },
  {
    question: '運営元はどこですか？',
    answer:
      'CABUILDキャンパスは、NINJAPAN株式会社が提供するサービスです。NINJAPAN株式会社は、就活内定率98.2%を誇る就活塾「Abuild就活」を運営しており、全国約110大学・受験生の2/3以上が利用する大学受験ポータルサイト「UCARO」を提供するODKソリューションズ（東証：3839）グループの一員です。',
  },
  {
